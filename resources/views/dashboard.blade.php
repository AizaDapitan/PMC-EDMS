                                ...
                                <tbody>
                                    ...
                                    @foreach( $downtime as $down ) 
                                        <tr>
                                            ...
                                            @else
                                                <button disabled class="btn purple btn-sm" title="Edit Downtime"><i class="fa fa-edit"></i></button>
                                            @endif
                                            @if($deleteDowntime)   
                                                <a href="#" class="btn red btn-sm deletedl" data="{{$down->id}}"
                                                    title="Delete Downtime"><i class="fa fa-minus-circle"></i></a>
                                            @else
                                            <button disabled class="btn red btn-sm"
                                                    title="Delete Downtime"><i class="fa fa-minus-circle"></i></button>
                                            @endif
                                            </td>
                                        </tr>
                                    @endforeach
