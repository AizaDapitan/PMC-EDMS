...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <h3 class="page-title">
                EDMS <small>Edit Genset Record</small>
            </h3>
    ...
    <div class="col-md-6 col-sm-12">
        ...
        <form role="FORM" method="POST" action="/genset/{{$genset->id}}">
            ...
            <div class="form-group @error('unit_id') has-error @enderror">
                ...
                @error('unit_id')
                    <span for="unit_id" class="help-block">{{ $message }}</span>
                @enderror
            ...
            <div class="form-group date form_datetime @error('startd') has-error @enderror">
                ...
                <div class="input-group date form_datetime">
                    <input type="text" size="16" name="start_date" id="startd" readonly class="form-control" 
                        onchange="checkinput();" required="required" value="{{ $genset->start_date->format('Y-m-d H:i') }}">
            ...
            <div class="form-group date form_datetime @error('endd') has-error @enderror">
                ...
                <div class="input-group date form_datetime">
                    <input type="text" size="16" name="end_date" id="endd" readonly class="form-control" 
                        onchange="checkinput();" required="required" value="{{ $genset->end_date->format('Y-m-d H:i') }}">
                    <span class="input-group-btn">
                    <button class="btn default date-set" type="button"><i class="fa fa-calendar"></i></button>
                    </span>
                </div>  
            ...
            <div class="form-group @error('fuel') has-error @enderror">

                <label for=""> Fuel consuption (liters): <span style="color: red;">*</span></label>
                <input type="text" name="fuel" class="form-control" value="{{ $genset->fuel }}">

                @error('fuel')
                    <span for="fuel" class="help-block">{{ $message }}</span>
                @enderror

            </div>

            <div class="form-group @error('kwh') has-error @enderror">

                <label for=""> KWH Delivered <span style="color: red;">*</span></label>
                <input type="text" name="kwh" class="form-control" value="{{ $genset->kwh }}">

                @error('kwh')
                    <span for="kwh" class="help-block">{{ $message }}</span>
                @enderror
            ...
            <div class="form-group @error('remarks') has-error @enderror">
                ...
                <textarea class="form-control" rows="10" name="remarks">{{ $genset->remarks }}</textarea>
...
@section('pageJS')
    ...
    <script type="text/javascript" src="/js/genset.js"></script>
    <script>
