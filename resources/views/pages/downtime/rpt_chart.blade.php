					...
					<div class="row">
						<div class="col-md-12">
							<table width="100%">
								<tr>
									<td align="center">
										<font color="blue" size="+1">Downtime List For Pareto Chart </font><br>
						...
						<div class="col-md-12">
							...
							<table width="100%">
								...
								<tr>
									...
									@php
										$_url = str_replace('/rpt_chart', '/rpt_chart_print', request()->getRequestUri());
									@endphp
	...
	<script>
		function exportToExcel(table){
			jQuery(table).table2excel({
				name: "DowntimePareto"+<?php echo date('Ymdhis'); ?>,
				filename: "DowntimePareto"+<?php echo date('Ymdhis'); ?> //do not include extension
			});
		}
	</script>
	<script>
