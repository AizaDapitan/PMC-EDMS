					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<table width="100%">
								<tr>
									<td align="center">
										<font color="blue" size="+1">Downtime List Flat Data </font><br>
						...
						<div class="col-md-12">
							...
							<table width="100%">
								...
								<tr>
									...
									@php
										$url = str_replace('/rpt_flatdata', '/rpt_chart', request()->getRequestUri());
										$_url = str_replace('/rpt_flatdata', '/rpt_flatdata_print', request()->getRequestUri());
									@endphp

									&nbsp;<a class="btn purple" href="{{$_url}}">Print</a>
									&nbsp;<a class="btn red" target="_blank" href="{{$url}}">Forward to Pareto Report</a>
								</td>
	...
	<script>
		function exportToExcel(table){
			jQuery(table).table2excel({
				name: "Downtime"+<?php echo date('Ymdhis'); ?>,
				filename: "Downtime"+<?php echo date('Ymdhis'); ?> //do not include extension
			});
		}
	</script>
	<script>
